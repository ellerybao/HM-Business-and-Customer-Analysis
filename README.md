...
**特殊处理**：官方未提供sales_channel_id的映射说明，本项目根据2020年4月渠道1销量骤降至零、渠道2同步上升的异常，结合H&M集团半年报披露当月超80%门店关闭，推断1为线下、2为线上；price字段为0-1归一化值，以淘宝H&M官方旗舰店120件T恤的实际售价为外部锚点，与数据集内T恤品类的归一化均价求得还原系数，外推至全表生成estimated_price字段；分析方法上综合运用RFM客户分层、品类偏好指数矩阵、同期群留存分析与Apriori关联规则挖掘。
...
- 核心战略稳定：结合H&M集团2019/2020年报与2026年半年报，其平价定位与渠道结构六年保持延续。 
- 渠道互补优势：2020年4月线下收入归零期间，线上收入环比上升41%，当月总收入环比上升24%；5月起线下迅速回升。
- 年龄群体差异：26-35岁群体消费能力最强，66岁以上群体可能呈现“低频高客单”特征。 
- RFM客户分层：22%的重要价值客户（R/F/M三项均高于中位数）与41%的一般挽留客户分别贡献57%和10%收入，收入高度集中且长尾客群存在转化空间。
- 品类关联方向：内裤对文胸的带动（置信度50%）显著高于反向（39%）。
### 6.业务建议

- 双线并行：以线上作为主渠道持续投入数字化运营与营销推广，同步筛选优化线下门店结构，保留高价值门店作为社交体验补充与外部风险对冲机制。 
- 分年龄段产品与营销组合：为可能存在隐性社交消费需求的26-35岁群体推动冬季保暖款设计升级；向16-25岁价格敏感群体倾斜平价内衣的关联捆绑与夏季泳装套装的库存出清；向36-45岁客群植入婴童服装的交叉推荐；为66岁及以上群体推出高品质经典款单品；
- RFM分层：通过专属权益与个性化推荐强化留存重要价值与重要保持客群；通过短信、邮件、上新推送等低成本触达尝试召回一般挽留客群；对重要唤回客群建立定向挽回通道。
...
- 渠道分析停留在总量层面，未拆分线上收入增量中的老客迁移与新客获取，无法区分渠道对冲与渠道替代。
